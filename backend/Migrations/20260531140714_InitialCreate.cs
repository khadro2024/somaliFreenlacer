    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkImageId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkImages_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "JobId");
                    table.ForeignKey(
                        name: "FK_WorkImages_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "ProjectId");
                    table.ForeignKey(
                        name: "FK_WorkImages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Websites and web apps", "Web Development" },
                    { 2, "UI/UX and graphics", "Design" },
                    { 3, "Content and copywriting", "Writing" },
                    { 4, "Digital marketing", "Marketing" },
                    { 5, "Somali and other languages", "Translation" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_JobId_FreelancerId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ProjectId_RaterId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkImages_JobId",
                table: "WorkImages",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkImages_ProjectId",
                table: "WorkImages",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkImages_UserId",
                table: "WorkImages",
                column: "UserId");
        }
